          ...
          <div className="border-b border-slate-100 px-4 py-3 flex items-center justify-between">
            <div>
              ...
              <p className="mt-0.5 text-[11px] text-slate-400">
                Name, basics, and status at a glance.
              </p>
            </div>
          </div>
              ...
              <table className="min-w-full text-xs">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/60 text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-500">
                    ...
                    <th className="px-3 py-2 text-left w-20">Bio</th>
                    <th className="px-3 py-2 text-left w-24">Website</th>
                    <th className="px-3 py-2 text-left w-24">Instagram</th>
                ...
                <tbody>
                  {artists.map((artist, idx) => {
                    ...
                    const renderStatus = (hasValue: boolean) =>
                      hasValue ? (
                        <span className="inline-flex items-center justify-center rounded-full bg-emerald-50 px-2 py-0.5 text-[11px] font-semibold text-emerald-700">
                          ✓
                        </span>
                      ) : (
